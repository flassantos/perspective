...
class Photos extends Controller{
	...
	public function index_index(){
		...
		$res6 = $photos->listaDados("id, nome, nome_url, foto, cidade_uf", "id>?", array("id"=>0), "nome");

		$photos->_tabela = "amizades";
		$res7 = $photos->listaDados("id_usuario, id_amigo", "(id_amigo=? OR id_usuario=?) AND status=?", array("id_amigo"=>$idGlobal, "id_usuario"=>$idGlobal, "status"=>1));
