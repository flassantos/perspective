		...
		<div class="sub_content">
			...
			foreach ($view_friends as $key => $value) {
				...
				?>
						...
						<a class="pl mhr" title="<?php echo $value['nome_amigo']; ?>" href="<?php echo System::getBase(); ?>user/<?php echo $value['nome_amigo_url']; ?>/">
				...
				if(count($view_friends) <= 0)
					echo "<div class='cleaner'></div><div class='text white'><center>Nenhum amigo encontrado.</center></div>";
				else
					echo "<div class='cleaner'></div><div class='text black'><center>Total: $totaldeamigos amigos</center></div>";
				?>
