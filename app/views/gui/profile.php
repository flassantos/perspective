...
<div id="profile">
	...
	<div id="avatar">
		...
		<div class="shadow">
			<!-- <img src="<?php echo $url; ?>" width="158" height="170" /> -->
			<div id="myprofilephoto" style="background-image: url(<?php echo $url2; ?>); width: 158px; height: 170px; background-position: center; background-size: cover;"></div>
		</div>
	...
	<div id="infos">
		...
		<?php
				...
				<a class="input_button pr tooltip" title="Remover Amizade" href="<?php echo System::getBase(); ?>add/delete/<?php echo $view_sobre['nome_url']; ?>/true/">
					<img src="images/icons/block.png" width="20" class="nmh" />
				</a>
